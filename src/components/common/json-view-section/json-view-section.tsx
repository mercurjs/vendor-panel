  ...
  return (
    <Container className="flex items-center justify-between px-6 py-4">
      ...
      <Drawer>
        ...
        <Drawer.Content className="text-ui-code-fg-subtle overflow-hidden border border-none bg-ui-contrast-bg-base !shadow-elevation-commandbar max-md:inset-x-2 max-md:max-w-[calc(100%-16px)]">
          ...
          <Drawer.Body className="flex flex-1 flex-col overflow-hidden px-[5px] py-0 pb-[5px]">
            <div className="flex-1 overflow-auto rounded-b-[4px] rounded-t-lg bg-ui-contrast-bg-subtle p-3">
