...
type CreateDataGridLocationStockColumnsProps<TData, TFieldValues extends FieldValues> = {
...
export const createDataGridLocationStockColumns = <TData, TFieldValues extends FieldValues>({
  stockLocations,
  isReadyOnly,
  getFieldName,
  t
}: CreateDataGridLocationStockColumnsProps<TData, TFieldValues>): ColumnDef<TData, unknown>[] => {
      ...
      return columnHelper.column({
        ...
        header: () => (
          <div className="flex w-full items-center justify-between gap-3">
            <span
              className="truncate"
              title={translatedStockLocationName}
            >
