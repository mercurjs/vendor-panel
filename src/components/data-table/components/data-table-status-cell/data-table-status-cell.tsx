...
export const DataTableStatusCell = ({ color, children }: DataTableStatusCellProps) => {
  return (
    <div className="txt-compact-small flex h-full w-full items-center gap-x-2 overflow-hidden text-ui-fg-subtle">
      <div
        role="presentation"
