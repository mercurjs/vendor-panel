      ...
      >
        {showTag && (
          <button
            ...
            className="txt-compact-small-plus absolute left-0.5 top-0.5 z-[1] flex h-[28px] items-center rounded-[4px] border bg-ui-bg-base py-[3px] pl-1.5 pr-1 text-ui-fg-subtle outline-none transition-fg focus-within:border-ui-fg-interactive hover:bg-ui-bg-base-hover"
          >
        ...
        <div className="relative flex size-full items-center">
          ...
          <PrimitiveCombobox
            ...
            className={clx(
              '!placeholder:text-ui-fg-muted txt-compact-small size-full cursor-pointer bg-transparent pl-2 pr-8 text-ui-fg-base outline-none transition-fg focus:cursor-text',
        ...
        {allowClear && controlledValue && (
          <button
            ...
            className="txt-compact-small-plus absolute right-[28px] top-0.5 z-[1] flex h-[28px] items-center rounded-[4px] border bg-ui-bg-base px-1.5 py-[2px] text-ui-fg-subtle outline-none transition-fg focus-within:border-ui-fg-interactive hover:bg-ui-bg-base-hover"
          >
            <XMarkMini className="text-ui-fg-muted" />
          </button>
        )}
          ...
          render={props => {
            return (
              <button
                {...props}
                type="button"
                className="absolute right-0 flex size-8 items-center justify-center rounded-r text-ui-fg-muted outline-none transition-fg hover:bg-ui-bg-field-hover"
              >
                <TrianglesMini />
              </button>
            );
