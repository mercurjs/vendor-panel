    ...
    return (
      <div className="relative">
        <Primitive
          ...
          {...props}
          className={clx(
            'txt-compact-small flex w-full select-none appearance-none items-center justify-between rounded-md bg-ui-bg-field px-2 py-1.5 pr-10 text-right caret-ui-fg-base shadow-buttons-neutral outline-none transition-fg',
