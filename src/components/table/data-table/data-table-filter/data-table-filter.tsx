      ...
      filters.forEach(filter => {
        ...
        if (value && !activeFilters.find(af => af.key === filter.key)) {
          if (filter.type === 'select') {
            ...
            setActiveFilters(prev => [...prev, { ...filter, openOnMount: false }]);
          }
        }
      });
    }
          ...
          >
            ...
            <RadixPopover.Portal>
              <RadixPopover.Content
                className={clx(
                  'z-[1] h-full max-h-[232px] w-[300px] overflow-auto rounded-lg bg-ui-bg-base p-1 text-ui-fg-base shadow-elevation-flyout outline-none'
                )}
