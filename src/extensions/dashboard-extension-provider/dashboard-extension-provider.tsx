...
export const DashboardExtensionProvider = ({ api, children }: DashboardExtensionProviderProps) => {
  return (
    <DashboardExtensionContext.Provider value={api}>{children}</DashboardExtensionContext.Provider>
  );
};
