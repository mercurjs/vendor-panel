...
export const shippingOptionsQueryKeys = queryKeysFactory(SHIPPING_OPTIONS_QUERY_KEY);
...
export const useDeleteShippingOption = (
  optionId: string,
  options?: UseMutationOptions<HttpTypes.AdminShippingOptionDeleteResponse, FetchError, void>
) => {
  return useMutation({
    mutationFn: () =>
