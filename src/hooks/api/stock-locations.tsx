...
export const useCreateStockLocation = (
  ...
  return useMutation({
    ...
    onSuccess: async (data, variables, context) => {
      ...
      await fetchQuery(`/vendor/stock-locations/${data.stock_location.id}/sales-channels`, {
        method: 'POST',
...
export const useDeleteStockLocation = (
  id: string,
  options?: UseMutationOptions<HttpTypes.AdminStockLocationDeleteResponse, FetchError, void>
) => {
  return useMutation({
    mutationFn: () =>
      fetchQuery(`/vendor/stock-locations/${id}`, {
