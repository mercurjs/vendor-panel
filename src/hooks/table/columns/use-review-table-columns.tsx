...
import { StarsCell, StarsHeader } from '../../../components/table/table-cells/review/stars-cell';
import { StatusCell, StatusHeader } from '../../../components/table/table-cells/review/status-cell';
