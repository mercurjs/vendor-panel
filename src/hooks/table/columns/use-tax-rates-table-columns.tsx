...
import { TypeCell, TypeHeader } from '../../../components/table/table-cells/taxes/type-cell';
  ...
  return useMemo(
    () => [
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => <TextCell text={row.original.tax_rate.tax_region.province_code ?? '-'} />
      }),
      columnHelper.display({
        id: 'rate',
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => <TypeCell is_combinable={row.original.tax_rate.is_combinable} />
      }),
      columnHelper.display({
        id: 'code',
