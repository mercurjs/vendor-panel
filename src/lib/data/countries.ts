...
export interface StaticCountry extends Required<Omit<HttpTypes.AdminRegionCountry, 'id'>> {}

export function getCountryByIso2(iso2: string | null): StaticCountry | undefined {
  if (!iso2) {
    return;
  }
