...
export const getOrderFulfillmentStatus = (t: TFunction<'translation'>, status: string) => {
  const [label, color] = {
    not_fulfilled: [t('orders.fulfillment.status.notFulfilled'), 'red'],
    partially_fulfilled: [t('orders.fulfillment.status.partiallyFulfilled'), 'orange'],
    fulfilled: [t('orders.fulfillment.status.fulfilled'), 'green'],
    partially_shipped: [t('orders.fulfillment.status.partiallyShipped'), 'orange'],
    shipped: [t('orders.fulfillment.status.shipped'), 'green'],
    delivered: [t('orders.fulfillment.status.delivered'), 'green'],
    partially_delivered: [t('orders.fulfillment.status.partiallyDelivered'), 'orange'],
    partially_returned: [t('orders.fulfillment.status.partiallyReturned'), 'orange'],
