      ...
      >
        <RouteFocusModal.Header>
          <RouteFocusModal.Title asChild>
            <VisuallyHidden>{t('apiKeyManagement.salesChannels.title')}</VisuallyHidden>
          </RouteFocusModal.Title>
          <RouteFocusModal.Description asChild>
            <VisuallyHidden>{t('apiKeyManagement.salesChannels.description')}</VisuallyHidden>
          </RouteFocusModal.Description>
          <div className="flex items-center justify-end gap-x-2">
            {form.formState.errors.sales_channel_ids && (
              <Hint variant="error">{form.formState.errors.sales_channel_ids.message}</Hint>
            )}
          </div>
        </RouteFocusModal.Header>
