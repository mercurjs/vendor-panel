...
export const AdjustInventoryForm = ({ item, level, location }: AdjustInventoryFormProps) => {
  ...
  const { mutateAsync, isPending: isLoading } = useUpdateInventoryLevel(item.id, level.location_id);
