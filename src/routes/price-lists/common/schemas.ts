...
export type PriceListCustomerGroup = z.infer<typeof PriceListCustomerGroupSchema>;
...
export type PriceListCreateCurrencyPrice = z.infer<typeof PriceListCreateCurrencyPriceSchema>;

const PriceListCreateRegionPriceSchema = z.object({
  amount: z.string().or(z.number()).optional()
});

export type PriceListCreateRegionPriceSchema = z.infer<typeof PriceListCreateRegionPriceSchema>;
...
export type PriceListCreateProductsSchema = z.infer<typeof PriceListCreateProductsSchema>;
...
export type PriceListUpdateCurrencyPrice = z.infer<typeof PriceListUpdateCurrencyPriceSchema>;
...
export type PriceListUpdateRegionPrice = z.infer<typeof PriceListUpdateRegionPriceSchema>;
...
export type PriceListUpdateProductsSchema = z.infer<typeof PriceListUpdateProductsSchema>;
