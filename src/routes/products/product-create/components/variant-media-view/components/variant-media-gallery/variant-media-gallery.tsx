...
import { ThumbnailBadge, TriangleLeftMini, TriangleRightMini } from '@medusajs/icons';
...
export const VariantMediaGallery = ({ goToEdit, variantMedia = [] }: VariantMediaGalleryProps) => {
