    ...
    <VariantMediaViewContext.Provider value={contextValue}>
      <StackedFocusModal.Content>
        <StackedFocusModal.Header>
          {view === View.EDIT ? (
            <Button
              variant="secondary"
              size="small"
              onClick={contextValue.goToGallery}
            >
        ...
        <StackedFocusModal.Body className="flex flex-col overflow-hidden">
          {view === View.GALLERY && (
            <VariantMediaGallery
              goToEdit={contextValue.goToEdit}
              variantMedia={initialMedia}
            />
          )}
          {view === View.EDIT && (
          ...
          <StackedFocusModal.Footer>
            <div className="flex justify-end gap-x-2">
              <Button
                ...
                size="small"
                onClick={onClose}
                data-testid="variant-media-cancel"
              >
                {t('actions.cancel')}
              </Button>
              <Button
                ...
                data-testid="variant-media-save"
              >
                {t('actions.save')}
              </Button>
            </div>
