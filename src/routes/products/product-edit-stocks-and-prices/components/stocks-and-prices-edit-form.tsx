...
const useStocksAndPricesGridColumns = ({
  ...
  return useMemo(() => {
    return [
            ...
            <DataGrid.ReadonlyCell context={context}>
              <div
                className={`flex items-center gap-x-2 overflow-hidden ${
                  isProductInfo ? 'bg-ui-bg-field text-ui-fg-disabled' : 'text-ui-fg-subtle'
                }`}
              >
                <Text
                  as="span"
      ...
      ...createDataGridLocationStockColumns<HttpTypes.AdminProductVariant, ProductCreateSchemaType>(
        {
          stockLocations,
