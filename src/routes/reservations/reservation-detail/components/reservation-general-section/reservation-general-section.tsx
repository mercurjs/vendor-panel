...
export const ReservationGeneralSection = ({ reservation }: ReservationGeneralSectionProps) => {
  const { t } = useTranslation();

  const { inventory_item: inventoryItem } = useInventoryItem(reservation.inventory_item_id, {
  ...
  const locationLevel = inventoryItem?.location_levels?.find(
    (l: HttpTypes.AdminInventoryLevel) => l.location_id === reservation.location_id
  );
