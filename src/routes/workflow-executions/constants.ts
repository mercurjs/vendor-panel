...
export const STEP_OK_STATES: HttpTypes.TransactionStepState[] = [TransactionStepState.DONE];
...
export const TRANSACTION_OK_STATES: HttpTypes.TransactionState[] = [TransactionState.DONE];
