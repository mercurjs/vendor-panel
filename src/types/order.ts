...
export type OrderPaymentStatus = 'pending' | 'captured' | 'partially_refunded' | 'refunded';
...
export type ExtendedAdminProductVariant = Omit<HttpTypes.AdminProductVariant, 'inventory_items'> & {
